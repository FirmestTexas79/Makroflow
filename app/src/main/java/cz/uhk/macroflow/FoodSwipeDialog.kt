...
class FoodSwipeDialog : DialogFragment() {
    ...
    private fun updateContextBanner(view: View, ctx: TrainingTimeManager.MealContext) {
        ...
        banner.text = text
        banner.backgroundTintList = android.content.res.ColorStateList.valueOf(
    ...
    private fun updateUI(view: View) {
        ...
        if (tag != null) {
            ...
            tvTag?.backgroundTintList = android.content.res.ColorStateList.valueOf(
    ...
    private fun handleConfirm(view: View) {
        ...
        lifecycleScope.launch {
            ...
            val entity = ConsumedSnackEntity(
                ...
                time = java.text.SimpleDateFormat("HH:mm", java.util.Locale.getDefault()).format(now),
                name = snack.name,
                p = snack.p,
                s = snack.s,
                t = snack.t,
            ...
            AppDatabase.getDatabase(requireContext()).consumedSnackDao().insertConsumed(entity)
