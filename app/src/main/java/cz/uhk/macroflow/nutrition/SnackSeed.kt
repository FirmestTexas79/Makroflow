...
/**
 * Výchozí obsah špajzky při prvním spuštění (hodnoty na uvedenou porci; zelenina, ovoce,
 * maso a mléčné výrobky podle českých nutričních tabulek). Vytaženo z SnackFragmentu.
 */
object SnackSeed {
    val DEFAULTS: List<SnackEntity> = listOf(
        SnackEntity(
