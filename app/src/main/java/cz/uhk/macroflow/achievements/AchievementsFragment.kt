...
import cz.uhk.macroflow.pokemon.PokemonShopFragment
...
class AchievementsFragment : Fragment() {
    ...
    private val GHOST_PURPLE = Color.parseColor("#6A4C93")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            val coinBalance = withContext(Dispatchers.IO) {
                AppDatabase.Companion.getDatabase(requireContext()).coinDao().getBalance()?.balance ?: 0
            }
    ...
    private fun renderUI(view: View, unlockedIds: Map<String, Long>, coinBalance: Int) {
        ...
        view.findViewById<TextView>(R.id.tvAchievementSub)?.apply {
            ...
            setTextColor(Color.argb(160, 40, 54, 24))
        }
    ...
    private fun buildCoinShopCard(coinBalance: Int): MaterialCardView {
        ...
        val tvLabel = TextView(ctx).apply {
            text      = "💰  Tvoje coiny"
            textSize  = 11f
            setTextColor(Color.argb(180, 254, 250, 224))
        }
        ...
        val tvInfo = TextView(ctx).apply {
            ...
            textSize  = 9.5f
            setTextColor(Color.argb(130, 254, 250, 224))
            layoutParams = LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    private fun buildCard(def: AchievementDef, unlockedAt: Long?): MaterialCardView {
        ...
        if (!unlocked) {
            ...
            inner.addView(TextView(ctx).apply {
                ...
                background = GradientDrawable().apply {
                    ...
                    cornerRadius = 20f * dp
                    setColor(Color.argb(30, 188, 108, 37))
                }
        ...
        inner.addView(TextView(ctx).apply {
            ...
            textSize  = 8.5f
            typeface  = Typeface.DEFAULT_BOLD
            setTextColor(if (unlocked) tierStroke else Color.argb(100, 40, 54, 24))
            gravity   = Gravity.CENTER
            letterSpacing = 0.1f
            layoutParams = LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
            ...
            background = GradientDrawable().apply {
                ...
                setStroke(
                    ...
                    else Color.argb(60, 40, 54, 24)
                )
                setColor(
                    if (unlocked) adjustAlpha(tierStroke, 0.10f)
                    else Color.argb(20, 40, 54, 24)
                )
            }
            setPadding(
