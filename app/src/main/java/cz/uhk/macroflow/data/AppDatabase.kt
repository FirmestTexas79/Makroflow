...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private fun getKantoNames(): List<Triple<String, String, String>> = listOf(
            ...
            Triple("Caterpie", "HMYZ / PROTEIN", "Nenápadný začátek, ale i malý červík v sobě skrývá zárodek budoucích bílkovin."),
            Triple("Metapod", "HMYZ / REGENERACE", "Tuhá schránka značí izometrickou kontrakci. Zpevni střed těla a drž plank!"),
            Triple("Butterfree", "HMYZ / LEHKOST", "Lehká jídla před tréninkem, která tě nezatíží. Poletuj po fitku plný energie."),
            ...
            Triple("Ghastly", "DUCH / LEHKÁ VÁHA", "Váha na čince je jen iluze. Důležité je procítění svalu."),
            ...
            Triple("Drowzee", "PSYCHICKÝ / REM SPÁNEK", "Hluboká fáze spánku, kdy se vylučuje růstový hormon (HGH)."),
